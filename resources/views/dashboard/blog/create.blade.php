...
@section('content')
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control @error('judul') is-invalid @enderror"  placeholder="Judul Blog" name="judul" value="{{old('judul')}}"> 
    @error('judul')
  ...
  <div class="form-group">
    <label>Content :</label>
    <textarea name="isi" class="form-control @error('isi') is-invalid @enderror" id="my-editor" value="{!!old('isi')!!}"></textarea>
     @error('isi')
              <div class="invalid-feedback">{{ $message }}</div>
     @enderror
  </div>
