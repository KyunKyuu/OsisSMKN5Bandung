            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Jumlah Sekbid</p>
                      <p class="card-title">{{$sekbid}}<p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Jumlah Blog</p>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Jumlah Kandidat</p>
                      <p class="card-title">{{$kandidat}}<p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Siswa Sudah Memilih</p>
                      <p class="card-title">{{$sudah_memilih}}<p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Siswa Belum Memilih</p>
                      <p class="card-title">{{$belum_memilih}}<p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="card ">
              ...
              @if($waktu)
                ...
                <h5 class="card-title">Voting Belum Dimulai</h5>
